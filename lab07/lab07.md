...
4. Какой порядковый номер у SYNACK-сегмента, отправленного сервером gaia.cs.umass.edu
   ...
   - значение было получено как Seq прошлого SYN-сегмента плюс 1
   - Flags: 0x012 (SYN, ACK)
...
6. Рассмотрите TCP-сегмент, содержащий команду POST протокола HTTP, как первый TCP-сегмент 
   ...
   - порядковые номера: 1, 612, 3468, 6324, 9180, 12036, далее о каждом из пакетов:

   - 81, время отправки 9.319817722, Seq:1, Len:611
   - 82, время отправки 9.319931115, Seq:612, Len:2856
   - 83, время отправки 9.319945697, Seq:3468, Len:2856
   - 86, время отправки 9.321031266, Seq:6324, Len:2856
   - 87, время отправки 9.321044306, Seq:9180, Len:2856
   - 88, время отправки 9.322470865, Seq:12036, Len:1428


<img src="images/image-5.png"/>
   
   - 9.524079493, 9.524079936, 9.524079996, 9.524080101, 9.524080211, 9.524199386
   - 0.204261771, 0.204148821, 0.204134299, 0.203048835, 0.203035905, 0.201728521
...
7. Чему равна пропускная способность (количество байтов, передаваемых в единицу
   ...
   - 154300 байт/с
   - 152.191 × 1024 / 1.01 = 154300 байт/с, делим объем данных к серверу на длительность соединения
