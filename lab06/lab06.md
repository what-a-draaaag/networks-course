...
3. Значение в поле Length (Длина) – это длина чего?
   - Это длина всего UDP-сегмента, состоит из длины заголовка и полезной нагрузки
4. Какое максимальное количество байт может быть включено в полезную нагрузку UDP-пакета?
   - Это поле занимает 2 байта, значит максимальное значение = $2^{16} - 1 = 65535$ байт, отнимем длину заголовка и получится $65535-8=65527$ байт
5. Чему равно максимально возможное значение номера порта отправителя?
   - Source Port занимает 2 байта, так что максимально возможное значение равно $65535$
...
7. Проверьте UDP-пакет и ответный UDP-пакет, отправляемый вашим хостом. Определите
   ...
   - Номера портов одни и те же, просто меняются местами относительно запроса
